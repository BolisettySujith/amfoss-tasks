...
public class MathQuiz extends JFrame 
{
    ...
    //variables
    int operator,undefined ;
    int correctCount, wrongCount = 0;
    double num1, num2, result,interval;
    String question;
    ...
    Font sizefont = new Font("Verdana", Font.BOLD, 50);
    ...
    public MathQuiz() 
    {
        ...
        titledBorder.setTitleColor(Color.BLACK); // the color is added to the object "title".
        ...
        correctAnswer.setFont(sizefont);
        correctAnswer.setForeground(Color.white);
        wrongAnswer.setFont(sizefont);
    ...
    class startListener implements ActionListener 
    {
        public void actionPerformed(ActionEvent e) 
        {
            ...
            if (interval == 4) 
            {
                ...
                double doubleOfInterval1 = Double.parseDouble(interval1.getText());
                double doubleOfInterval2 = Double.parseDouble(interval2.getText());
